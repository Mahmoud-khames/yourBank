...
const JobCarees = () => {
  return (
    <div className="jobCarees container">
      ...
      <div className="allBoxs">
              ...
              <div className="second_content">
                ...
                <div className="description">
                  <p>
                    ...
                    identifying and assessing potential risks to our
                    organization. You will analyze data, conduct risk
                    assessments, and develop strategies to mitigate risks. We
                    are looking for detail-oriented individuals with strong
                    analytical skills and a solid understanding of risk
        ...
        <div className="boxs_2 boxs">
          ...
          <div style={{ padding: "40px"  , flex: '1 ' }}></div>
        </div>
      </div>
    </div>
  );
