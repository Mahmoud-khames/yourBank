...
const AnimatedNumber = ({ targetNumber }) => {
  ...
  useEffect(() => {
    if (inView) {
      ...
      const increment = Math.ceil(targetNumber / (duration / 10)); // الزيادة في كل خطوة
      ...
      }, 50); // التحديث كل 50 مللي ثانية
    }
  }, [inView, targetNumber]);

  return (
    <h2 ref={ref} className="number">
      {currentNumber}%
    </h2>
  );
};
const CasesHome = () => {
  return (
    <div className="casesHome container overflow-hidden">
      ...
      <div className="all_info_cases">
        <div className="cases_info position-relative">
          ...
          <div className="icon">
            <div className="icon_box_info">
              <div className="icon_box">
                ...
                <div className="description">Managing Personal Finances</div>
              </div>
              <div className="icon_box">
                <div className="i">
                  <span></span>
                ...
                <div className="description">Saving for the Future</div>
              </div>
            </div>
            <div className="icon_box_info">
              <div className="icon_box">
                ...
                <div className="description">Homeownership</div>
              </div>
              <div className="icon_box">
                <div className="i">
                  <span></span>
                ...
                <div className="description">Education Funding</div>
              </div>
            </div>
          </div>
        </div>
        <div className="info_content">
          ...
          <div className="box_number">
            ...
            <div>
            <AnimatedNumber targetNumber={63} />
              <div className="description">Manageable Debt Consolidation</div>
            </div>
            <div>
            <AnimatedNumber targetNumber={91} />
      ...
      <div className="all_info_cases two">
        <div className="info_content">
          <div className="box_content">
          ...
          <div className="icon">
            <div className="icon_box_info">
              <div className="icon_box">
                ...
                <div className="description">Startups and Entrepreneurs</div>
              </div>
              <div className="icon_box">
                <div className="i">
                  <span></span>
            ...
            <div className="icon_box_info">
              <div className="icon_box">
                ...
                <div className="description">Business Expansion</div>
              </div>
              <div className="icon_box">
                <div className="i">
                  <span></span>
                ...
                <div className="description">Payment Solutions</div>
              </div>
            </div>
          </div>
        </div>
